...
export class Backend implements backendInterface {
    ...
    async addFavoriteColor(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addFavoriteColor(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async countUserFavorites(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.countUserFavorites();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteFavoriteById(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteFavoriteById(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteUserAccount(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteUserAccount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFavorites(): Promise<Array<FavoriteColor>> {
        if (this.processError) {
            try {
    ...
    async getHarmonyAdvice(arg0: string): Promise<HarmonyPalette> {
        if (this.processError) {
            try {
                const result = await this.actor.getHarmonyAdvice(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async verifyEmail(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.verifyEmail();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
